...
EMSCRIPTEN_BINDINGS(blsjs) {
    class_<AugSchemeMPLWrapper>("AugSchemeMPL")
        .class_function("get_public_key", &AugSchemeMPLWrapper::GetPublicKey)
    ...
    class_<PopSchemeMPLWrapper>("PopSchemeMPL")
        .class_function("get_public_key", &PopSchemeMPLWrapper::GetPublicKey)
    ...
    class_<LegacySchemeMPLWrapper>("LegacySchemeMPL")
	...
	*/
    ...
    class_<PrivateKeyWrapper>("PrivateKey")
        ...
        .function("get_public_key", &PrivateKeyWrapper::GetPublicKey)
